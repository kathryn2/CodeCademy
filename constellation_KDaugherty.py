...
#Create figure for 2d plot and save it to a varaible name
fig = plt.figure()
...
#Set custom color for full credit
plt.scatter(x,y,c="orange")

#Add customizations for full credit
...
#Add subplot and set to 3d
fig_3d.add_subplot(1,1,1,projection="3d")

#Create new variable
#Add custom color just because you can
constellation3d = plt.scatter(x,y,z,c="purple")

#Add title for full credit
